...
const handleSubmit = async (e) => {
  ...
  return (
    ...
    <section className='max-w-7xl mx-auto'>
       ...
       <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w [500px] '>
          Create imaginative and visually stunning images generated by Pollinations AI and share
        </p>
      </div>
    ...
    <div className='mt-10'>
      ...
      <p className='mt-2 text-[#666e75] text-[14-px]'>Once you generate an image you want ,you can share it wth other in the community
      </p>
